...
'            Me.buttonCreateTheme.Click += New System.EventHandler(Me.buttonCreateTheme_Click)
            ' 
            ' buttonDeleteTheme
            ' 
...
'            Me.buttonDeleteTheme.Click += New System.EventHandler(Me.buttonDeleteTheme_Click)
            ' 
            ' MainForm
            ' 
